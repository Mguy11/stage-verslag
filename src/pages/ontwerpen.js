                    ...
                    <div label="Idee + Brainstormen">
                        <Row>
                            <ContentBlockLarge
                                ...
                                title = ""
                                body = "Tijdens mijn stageperiode bij DotControl heb ik me volledig op development gericht. Ik heb een aantal keer aangegeven dat ik een graag een creatieve sessie zou bijwonen, maar daar is niks van gekomen. Daarom heb ik besloten zelf een website te bouwen om toch mijn Ontwerp competentie te kunnen halen. Ik wilde daarbij ook mezelf weer uitdagen om ook wat te gaan leren, dus heb ik gekozen een stagewebsite te bouwen in React met SCSS."
                            />
                            <ContentBlockLarge
                                className = "contentblock contentblock--alinea"
                                title = ""
                                body = "Ook wil ik hem responsive maken, omdat daar de grootste uitdagingen liggen qua frontend. Verder heb ik er voor gekozen om de backend voor nu zo simpel mogelijk te houden, dus ik zet ook mijn teksten statisch op mijn website en maak het pas dynamisch als ik tijd over heb."
                            />
                            <ContentBlockLarge
                                className = "contentblock contentblock--alinea"
                                title = ""
                    ...
                    <div label="Wireframes">
                        <Row>
                            <ContentBlockLarge
                                className = "contentblock contentblock--alinea"
                                title = ""
                                body = "Uiteindelijk had ik een idee om een van te maken. Het design is een beetje gebaseerd op al het werk wat ik gedaan heb tijdens mijn stage, maar wel met een Marijn Bankert filter er overheen. Oftewel een donker thema, alles strak en recht en vooral functioneel. 
                                        Maar voor ik het echte design heb gemaakt heb ik eerst wireframes opgesteld . Hierdoor had ik een goed overzicht waar alles zou komen op mijn website en kon ik van tevoren nog dingen aanpassen. Dat scheelde tijd tijdens het ontwikkelen."
                            />
                        </Row>   
                    </div>
                    <div label="Navigatie website">
                        <Row>
                            <ContentBlockLarge
                                className = "contentblock contentblock--alinea"
                                title = ""
                                body = "Een onderdeel waar ik veel tijd in gestoken heb is mijn navigatie. Dit is altijd al een van de meest complexe onderdelen van een website en dat was nu geen uitzondering. Ik heb hem ondertussen al een aantal keer overnieuw gebouwd,
                                        omdat ik het niet helemaal eens was met het uiterlijk of hoe hij functioneerde. Uiteindelijk is de huidige versie ook de versie die ik het beste vond. Hij is voor desktop simpel, overzichtelijk en vooral abstract. Voor mobile is hij dat ook maar op een andere manier. Het enige waar ik het nog niet over eens ben is de animatie. Die zal ik hoogstwaarschijnlijk nog een keer veranderen."
                            />
                        </Row>  
                    </div>
                        ...
                        <Row>
                            <div>
                                <ul>
                                    ...
                                    <li>Als bezoeker wil ik dat de content leesbaar is, zodat ik het kan lezen.</li>
                                </ul>
                            </div>
                        </Row>  
                    </div>
