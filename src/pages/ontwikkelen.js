        ...
        <div className="ontwikkelen">
            ...
            <Grid>
                <TestimonialBlock
                    ...
                    body1="De CMGT'er beschikt over kennis van ontwikkeltalen, -frameworks, -omgevingen, en kan deze met weinig begeleiding toepassen bij het analyseren van een probleem in een praktijksituatie. 
                    Hij houdt daarbij rekening met de bestaande situatie en de wensen van de betrokken stakeholders. "
                    subtitle2="Ontwikkelen en prototypen: "
                    body2="De CMGT'er is in staat om iteratief te ontwikkelen, om zo deadlines en afspraken na te komen. Hij heeft een gedegen kennis 
                    op programmeergebied en is flexibel genoeg om zich snel in te werken in nieuwe talen, platformen, tools en de werkwijze binnen het stagebedrijf. "
